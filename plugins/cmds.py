...
async def start(bot, update):
    buttons = [[
        ...
        InlineKeyboardButton('Support Group 📌', url='https://t.me/NekoneSupport')
        ],[
        InlineKeyboardButton('🎸 Source Code', url='https://github.com/IzzyLord/TGraph-Bot'),
...
async def help_user(bot, update):
    ...
    buttons = [[
        InlineKeyboardButton('📌 Support Group', url='https://t.me/NekoneSupport'),
        InlineKeyboardButton('Update Channel 📜', url='https://t.me/NekoneProjects')
        ],[
